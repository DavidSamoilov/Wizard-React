  ...
  return (
    <>
      ...
      <div className="text-center">
        <Button className='display-button' variant="primary" onClick={() => history.push("/phase3")}>
          Back
        </Button>
        <ResetDataButton className='display-button reset-button' onClick={clearLocalStorage} text="Reset form" />
      </div>
    </>
  );
}
